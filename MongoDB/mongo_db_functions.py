    ...
    def get_pyramid(self, pyramid_object):
        try:
            ...
            if((pyramid_document['pyr_file_content'] == '') and (pyramid_document['size_file_content'] == '')):
                ...
                pyramid_object.create_pyramid_files(pyramid_document['pyr_file_content'],pyramid_document['size_file_content'])
                                ...
                                'result':
                                    {
                                            ...
                                            'Pyramid Name' : result_obj.pyramid_name,
                                            'Raw' : result_obj.raw,
                                            ...
                                            'Content Unit' : result_obj.content_unit_list,
